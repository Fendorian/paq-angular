  ...
  setLanguageContent(language: string){
    switch (language) {
         case 'en':
           ...
           this.description1 = "The PAQ brand includes the production of plastic cups, paper cups and cutlery and other products that are visible on our product catalog. These include disposable and reusable products.";
           ...
           this.shopText = "Products";
           break;
         case 'hr':
           this.mainTitle1 = "Firma i brand";
           this.mainTitle3 = "Naša Misija";
           this.mainTitle4 = "Društvena odgovornost";
           this.description1 = " PAQ brand obuhvata proizvodnju plastičnih čaša, papirnih čaša i pribora za jelo i ostalih proizvoda koji su vidljivi na našem katalogu proizvoda. Tu spadaju proizvodi za jednokratnu i višekratnu upotrebu.";
           ...
           this.shopText = "Proizvodi";
           break;
         case 'de':
           this.mainTitle1 = "Unternehmen & Marke"
           this.mainTitle3 = "Unsere Mission"
           this.mainTitle4 = "Gesellschaftliche Verantwortung"
           this.description1 = "Die Marke PAQ umfasst die Produktion von Plastikbechern, Pappbechern und Besteck sowie anderen Produkten, die in unserem Produktkatalog sichtbar sind. Hierzu zählen Einweg- und Mehrwegprodukte."
